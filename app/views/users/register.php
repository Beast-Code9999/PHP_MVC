            ...
            <form action="<?php echo base_url('user/register'); ?>" method="POST" class="form">
                ...
                <div class="checkbox-group">
                    <label class="checkbox-label">
                        ...
                        <span class="checkbox-text">By clicking "Register" you agree on our Privacy Policy</span>
                    </label>
                </div>
    ...
    <div class="register-right">
        <div class="hero-content">
            ...
            <p class="hero-description">
                Create an account to get unlimited access to in-depth reporting across Northern Australia and Southeast Asia. As a member, you'll enjoy
            </p>
        </div>
    </div>
</div>